...
export const Home = () => {
  ...
  return (
    <div className="space-y-8">
      <section className="relative overflow-hidden rounded-3xl bg-indigo-900 px-6 py-24 text-center sm:px-12 lg:px-16">
        <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center mix-blend-overlay" />
        <div className="relative z-10 mx-auto max-w-3xl space-y-6">
          ...
          <div className="mx-auto mt-8 flex max-w-xl items-center gap-2 rounded-2xl bg-white p-2 shadow-xl focus-within:ring-2 focus-within:ring-indigo-500">
            ...
            />
            <Button variant="primary" className="rounded-xl px-6">Search</Button>
          </div>
        </div>
      </section>
